...
// instead of "incomplete"/"restricted"). This page (like finance/page.tsx's
// sibling billing/page.tsx -- the two were byte-for-byte identical before
// this fix, both pointing at the same billing/subscription backend) has no
// separate "finance" backend of its own; apps/api/routes/billing.py is the
// only real subscription/usage/invoice API in this deployment.
type BillingStatus =
  | "active"
  | "trialing"
  | "past_due"
